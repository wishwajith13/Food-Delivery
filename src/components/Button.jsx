const Button=({value,buttonOutline,setShowLogin})=>{
    return(
        
        <button onClick={()=>setShowLogin(true)} className={`group relative h-12 overflow-hidden overflow-x-hidden rounded-full bg-slate-50 px-8 py-2 text-black ${buttonOutline? buttonOutline:"" }`}>
