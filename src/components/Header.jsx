...
const Header =()=>{
    return(
        <div className="bg-header-img h-100 mt-7 m-auto bg-contain bg-no-repeat relative" >
            <div data-test="header-animate" className="absolute flex flex-col items-start gap-8 max-w-1/2 bottom-1/4 left-28 animate-fadein font-playfair">
